          ...
          <div class="table-responsive">
            <table class="table zero-configuration">
              ...
              <tr>
                ...
                <td>
                  <a href="edit_category.php?edit=<?php echo $DataFetch['id'];?>" class="btn btn-primary py-0 py-md-1 px-1 px-md-2 mb-1 my-md-0">Edit</a>
                  <a onclick="return confirm('Are You Sure')" href="?delete=<?php echo $DataFetch['id'];?>" class="btn btn-danger py-0 py-md-1 px-1 px-md-2">Delete</a>
                </td>
