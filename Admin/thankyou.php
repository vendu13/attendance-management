...
<head>
    ...
    <title>Thank You - Threados</title>
  ...
  <div class="col-xl-7 col-md-8 col-12">
    <div class="card bg-transparent shadow-none">
      <div class="card-body text-center bg-transparent">
        <img src="../impimage/thankyou.jpg" class="img-fluid" alt="not authorized" width="400">
        <h1 class="my-2 error-title">You Have SuccessFully Created New Password</h1>
        <p>Please Login Your Threados App.</p>
        <!-- <a href="index.html" class="btn btn-primary round glow mt-2">BACK TO HOME</a> -->
      </div>
    </div>
  </div>
</section>
