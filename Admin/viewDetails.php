...
$DataGet = mysqli_fetch_assoc(mysqli_query($conn,"SELECT *  FROM teacher left join `timesheet` ON teacher.id=timesheet.userID WHERE timesheet.userID=$id or teacher.id=$id "));
?>
      	...
      	<div class="table-responsive">
            <table class="table table-striped dataex-html5-selectors">
              ...
              <tbody>
                ...
                <?php
                $SelectData =mysqli_query($conn,"SELECT * FROM `timesheet` join teacher ON teacher.id=timesheet.userID WHERE timesheet.userID=$id ORDER BY timesheet.id DESC");
                $number = 1;
