<?include('header.php');
 $SelectData = mysqli_query($conn,"SELECT * FROM `timesheet` join teacher ON teacher.id=timesheet.userID ORDER BY timesheet.userId DESC");?>
    <!-- END: Main Menu-->
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="viewDetails.php?id=<?=base64_encode($DataFetch['userID'])?>"><?=$DataFetch['name'];?> </a>
                  </td>
