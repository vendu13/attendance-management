...
if (isset($_GET['edit'])) {
  $DataEdit = mysqli_fetch_assoc(mysqli_query($conn,"SELECT * FROM `tbl_category` WHERE `id`='".$_GET['edit']."'"));
            ...
            <div class="breadcrumbs-top">
              ...
              <div class="breadcrumb-wrapper d-none d-sm-block">
                <ol class="breadcrumb p-0 mb-0 pl-1">
                  ...
                  <li class="breadcrumb-item active"><a href="#"><?php if(isset($Detail)){ echo $Detail ; } else { echo "Add ";}?> Class</a>
                  </li>
                </ol>
              </div>
            </div>
