            ...
            <div class="breadcrumbs-top">
              ...
              <div class="breadcrumb-wrapper d-none d-sm-block">
                <ol class="breadcrumb p-0 mb-0 pl-1">
                  ...
                  <li class="breadcrumb-item active"><a href="#">Add Teacher</a>
                  </li>
                </ol>
              </div>
            </div>
          ...
          <form class="form form-vertical" id="formData">
            <div class="form-body">
              <div class="row">
                ...
                <div class="col-12">
                  <div class="form-group">
                    <label for="class-id-vertical">Department</label>
                    <input type="text"  class="form-control" name="department"
                      placeholder="Class" required id="department">
                  </div>
                </div>
...
$SelectData = mysqli_fetch_assoc(mysqli_query($conn,"SELECT * FROM `teacher` WHERE `id`='".$_GET['edit']."'"));
?>
    <div class="app-content content">
      <div class="content-overlay"></div>
      <div class="content-wrapper">
            ...
            <div class="breadcrumbs-top">
              ...
              <div class="breadcrumb-wrapper d-none d-sm-block">
                <ol class="breadcrumb p-0 mb-0 pl-1">
                  ...
                  <li class="breadcrumb-item active"><a href="#">Edit Teacher</a>
                  </li>
                </ol>
              </div>
            </div>
                ...
                <div class="col-6">
                  <div class="form-group">
                    ...
                    <input type="text"  class="form-control" name="class"
                      placeholder="Class" required id="department" value="<?php echo $SelectData['department'] ?>">
                  </div>
                </div>
