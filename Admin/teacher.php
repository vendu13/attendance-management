<?php include('header.php');
  ...
  $Detail="User";
  $SelectData = mysqli_query($conn,"SELECT * FROM `teacher` ORDER BY id DESC");

if (isset($_GET['delete'])) {
  $DeleteData = mysqli_query($conn,"DELETE FROM `teacher` WHERE `id`='".$_GET['delete']."'");
  if ($DeleteData) {
        ...
        <div class="content-header row">
          <div class="content-header-left col-12 mb-2 mt-1">
            <div class="breadcrumbs-top">
              <h5 class="content-header-title float-left pr-1 mb-0">All Teacher</h5>
              <div class="breadcrumb-wrapper d-none d-sm-block">
                <ol class="breadcrumb p-0 mb-0 pl-1">
                  <li class="breadcrumb-item"><a href="index.html"><i class="bx bx-home-alt"></i></a>
                  </li>
                  <li class="breadcrumb-item active">Teacher
                  </li>
                </ol>
              </div>
            </div>
          ...
          <div class="table-responsive">
            <table class="table zero-configuration">
              ...
              <tr>
                ...
                <td>
                  <a href="viewDetails.php?id=<?=base64_encode($DataFetch['id'])?>"><?=$DataFetch['name'];?></a>
                </td>
                <td><?php echo $DataFetch['email'];?></td>
                   <td><?php echo $DataFetch['mobile'];?></td>
               
                  <td><?php echo $DataFetch['department'];?></td>
                ...
                <td>
                  ...
                  <a href="teacher_management.php?edit=<?php echo $DataFetch['id'];?>" class="btn btn-primary"><i class="bx bxs-edit"></i></a>
